...
const STAGE_DUTY: Record<CreationStage, string> = {
  outline:
    ...
    '这一层也管**分卷**——把全书切成若干卷，每一卷是一条完整的中等弧线。\n' +
    '你不写单卷的细节走向，也不写正文——那是后面几层的事。',
  volume:
    '你负责一卷之内的走向：这一卷从什么局面开始、经过哪些事、主冲突在哪一步翻转、' +
    '收在什么局面上，以及它埋下什么、兑现前面哪一处。\n' +
    '这一层也管**从这一卷里拆出剧情段**——一次只拆一段，接着已经排好的那几段往下走。\n' +
    '**你不写具体画面、天气、动作细节或台词**，也不写正文。全书层面的结构不由你决定——' +
    '那在大纲里已经定了。',
  ...
  plot:
    ...
    '谁付出什么代价、最后收在什么局面上。\n' +
    '**你交出的是剧情脉络，不是正文。** 不要写具体的画面、天气、动作细节或台词——' +
    '那些是写正文时才定的东西；也不要规定这一段从哪句话开头、到哪句话结尾。\n' +
    '你也不必让这一章自成起讫：它是一条连续剧情里的一截，前面接着上一章的局面，' +
    '后面留给下一章。写多长由剧情本身决定——正文出来后作者会自己决定在哪里断章，' +
    '所以不必为了凑够一章而注水，也不必为了收在一章之内而强行收束。',
  manuscript:
    '你负责把已经定好的剧情写成文学文本。剧情走向不由你决定——那在本段的细纲里已经定了。' +
    '**画面、天气、动作细节与台词由你来定**：细纲只说事件与因果，怎么把它写成可感的场面' +
  ...
  switch (stage) {
    ...
    case 'plot':
      ...
      return [
        ...
        '**不要写具体画面、天气、动作细节或台词**，那些是写正文时才定的。也不要规定这一段的开头与结尾。',
