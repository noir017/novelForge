...
| `src/core/` | 核心逻辑层入口（含协议 protocol.ts、工程页快照 projectView.ts、资源管理器目录列举 fileTree.ts、类文件操作 fileOps.ts、日志 logger.ts、长任务 progress.ts） | [src/core/README.md](src/core/README.md) |
