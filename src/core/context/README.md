...
| **卷纲** | 分卷编剧 | **目标卷的卷纲 + 本卷已排的剧情段一览（两层都是 P0 force）**、大纲全文、分卷一览 | 正文原文 |
| **剧情** | 剧情编剧 | 本段剧情（P0 force）、大纲、**前 3 段与后 1 段的剧情原文**、更早段的正文摘要 | 正文原文 |
| **正文** | 作者 | **文风指南 P0 force**、**本段细纲 P0 force**、上一章结尾、近 N 章正文…全套 | —— |
...
- **只读用得上的文件**：`resolveFocus` 按配方决定读不读前后段的剧情、读不读分卷列表。正文阶段每次生成都多读三段用不上的剧情，那是落在关键路径上的浪费。
